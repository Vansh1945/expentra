...
4. [Database Models](#database-models)
   - [User Model](#user-usermodeljs)
   - [Expense Model](#expense-expensemodeljs)
   - [Budget Model](#budget-budgetmodeljs)
   - [Group Model](#group-groupmodeljs)
   - [GroupExpense Model](#groupexpense-groupexpensemodeljs)
   - [Notification Model](#notification-notificationmodeljs)
   - [Income Model](#income-incomemodeljs)
   - [Category Model](#category-categorymodeljs)
   - [Settlement Model](#settlement-settlementmodeljs)
